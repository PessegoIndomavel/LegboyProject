...
/*namespace _Scripts.Other
{
    ...
    public class UIScrollToSelection : MonoBehaviour
    {
        ...
        {
            GameStateManager.instance.onPause += SetIsPaused;
            GameStateManager.instance.onUnpause += SetIsPaused;
        }
        ...
        protected virtual void Update()
        {
            if (isPaused) return;
            UpdateReferences();
            selectedOutline.position = CurrentTargetRectTransform.position;
            CheckIfScrollingShouldBeLocked();
            ScrollRectToLevelSelection();
        }

        //called when pausing and when unpausing
        public void SetIsPaused()
        {
            isPaused = GameStateManager.instance.isPaused();
        }
