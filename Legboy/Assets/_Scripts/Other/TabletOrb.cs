...
public class TabletOrb : MonoBehaviour
{
    ...
    public static TabletOrb instance;
    private void Awake()
    {
        #region Singleton
    ...
    public void FlipOrbFollowPos(int side)
    {
        targetTransform.localPosition = new Vector3(side * Mathf.Abs(targetTransform.localPosition.x), targetTransform.localPosition.y, targetTransform.localPosition.z);
    }
